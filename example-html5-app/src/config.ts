...
const getFromEnv = (): Config => {
  return {
    ...
    reconnectionDelay: parseInteger(process.env.WS_RECONNECTION_DELAY, 1000),
    reconnectionDelayMax: parseInteger(process.env.WS_RECONNECTION_DELAY_max, 12 * 60 * 60 * 1000),
